# Project-101 : Kittens Carousel Static Website deployed on nginx Red Hat using Ansible

## Description
Kittens Carousel is a static website application deployed with Nginx Web Server on Red Hat Instance using Ansible playbook.
